...
//        Log.i("일",String.valueOf(day));
    ...
    public static final Creator<MyEventDay> CREATOR = new Creator<MyEventDay>() {
        @Override
        public com.example.stop_and_flight.MyEventDay createFromParcel(Parcel in) {
            return new com.example.stop_and_flight.MyEventDay(in);
        }
        @Override
        public com.example.stop_and_flight.MyEventDay[] newArray(int size) {
            return new com.example.stop_and_flight.MyEventDay[size];
        }
    };
    @Override
